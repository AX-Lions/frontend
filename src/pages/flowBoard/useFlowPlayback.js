 ...
 * 한 칸 넘어가는 데 걸리는 시간.
 *
 * 0.5초다. 이보다 빠르면(0.2초) 화살표가 한꺼번에 켜진 것처럼 보여 **순서를
 * 읽을 수 없고**, 느리면(1초) 스무 건짜리 회의를 끝까지 보는 데 20초가 걸려
 * 사람이 먼저 손으로 넘긴다. 눈이 새로 생긴 선을 좇아갈 수 있는 가장 짧은
 * 간격이 이쯤이다.
 *
 * 그래도 이 값이 누구에게나 맞지는 않는다. 뒤로·앞으로 버튼을 굳이 달아 둔
 * 것이 그 보정이다 — 속도를 고르게 하는 대신 **멈추고 직접 넘길 수 있게** 했다.
 */
