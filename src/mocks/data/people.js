 ...
 * 두 번째 팀.
 *
 * 학술제는 **해커톤 팀이 하는 일이 아니다.** 사람이 겹칠 뿐 심사도 일정도
 * 다른 곳에서 굴러간다. 그런데 목에서는 학술제 프로젝트가 해커톤 팀 밑에
 * 매달려 있어서, 채팅 목록만 보면 같은 팀이 두 가지를 하는 것처럼 읽혔다.
 *
 * 팀이 둘이어야 화면이 확인되는 것도 있다. 팀 하나짜리 트리는 **어디까지가
 * 이 팀인지**를 물을 필요가 없어서, 팀·프로젝트를 감싸는 표시가 맞는지
 * 확인할 방법이 없다.
 */
export const TEAM_ACADEMY = {
  id: 'b5f2c73a-9e41-4d08-8c6b-17ae05d29f34',
  name: '연합 학술제',
  description: '학술제 부스·발표 준비팀',
}

/**
 * 프로젝트는 **어느 팀 것인지 자기가 안다.**
 *
 * 예전에는 팀이 하나뿐이라 화면마다 `TEAM` 을 그냥 갖다 썼다. 팀이 둘이 되면
 * 그 방식은 조용히 틀린다 — 학술제 프로젝트 옆에 해커톤 팀 이름이 붙고,
 * 어느 화면에서 틀렸는지는 눈으로 찾아야 한다. 짝을 여기서 한 번만 맺는다.
 */
export const PROJECTS = {
  ...
  demo: {
    id: 'e3a1d76c-4b58-42f9-a0d3-8c6271b4e095',
    name: '데모 발표 준비',
    team: TEAM,
  },
  academy: {
...
/** 프로젝트가 매달린 팀. 짝을 못 찾으면 원래 팀으로 둔다. */
